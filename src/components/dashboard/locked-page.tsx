    ...
    <div className="relative min-h-[85vh]">
      ...
      <div className="blur-[6px] opacity-50 pointer-events-none select-none space-y-8 pb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="rounded-2xl border border-border bg-card p-4 shadow-sm flex flex-col gap-3">
        ...
        <div className="grid gap-6 lg:grid-cols-5">
          <div className="lg:col-span-3 rounded-2xl border border-border bg-card p-8 shadow-sm">
          ...
          <div className="lg:col-span-2 rounded-2xl border border-border bg-card p-8 shadow-sm flex flex-col items-center">
            <div className="w-48 h-6 bg-slate-200 rounded mb-10 self-start" />
            <div className="size-48 rounded-full border-[24px] border-border" />
          </div>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {[...Array(2)].map((_, i) => (
             <div key={`row2-${i}`} className="rounded-2xl border border-border bg-card p-8 shadow-sm">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {[...Array(2)].map((_, i) => (
             <div key={`row3-${i}`} className="rounded-2xl border border-border bg-card p-8 shadow-sm">
               <div className="w-32 h-6 bg-slate-200 rounded mb-8" />
               <div className="space-y-4">
                 {[...Array(5)].map((_, j) => (
                   <div key={j} className="flex items-center gap-4">
      ...
      <div className="absolute inset-0 flex items-start justify-center pt-24 z-10">
        <div className="bg-card p-8 rounded-2xl border border-border shadow-lg max-w-sm w-full text-center">
          ...
          <Link href="/home" className="text-sm text-muted-foreground hover:text-foreground font-medium transition-colors block">
            Maybe later
          </Link>
        </div>
      </div>
