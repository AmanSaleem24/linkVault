    ...
    <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="relative w-full sm:max-w-sm">
        ...
        <input
          ...
          className="h-10 w-full rounded-lg border border-border bg-card pl-10 pr-4 text-[0.9rem] text-foreground placeholder:text-muted-foreground shadow-sm transition-all hover:border-border focus:border-[#3D52A0] focus:outline-none focus:ring-2 focus:ring-[#3D52A0]/15"
        />
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="inline-flex h-10 items-center gap-2 rounded-lg border border-border bg-card px-4 text-[0.875rem] font-semibold text-foreground shadow-sm transition-colors hover:border-border hover:bg-muted/50 focus:outline-none">
            ...
            <svg className="size-3.5 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
        ...
        {/* View Mode Toggle */}
        <div className="ml-2 flex items-center rounded-lg border border-border bg-card p-0.5 shadow-sm">
          <button
            onClick={() => onViewModeChange('list')}
            className={`flex size-8 items-center justify-center rounded-md transition-colors ${viewMode === 'list' ? 'bg-muted text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground hover:bg-muted/50'}`}
            title="List View"
          >
          ...
          <button
            ...
            className={`flex size-8 items-center justify-center rounded-md transition-colors ${viewMode === 'compact' ? 'bg-muted text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground hover:bg-muted/50'}`}
            title="Compact View"
          >
