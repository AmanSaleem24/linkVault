...
import { Link as LinkIcon, Loader2, Plus, Download, RefreshCw } from 'lucide-react'
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            className="h-10 w-10 p-0 rounded-md border-border/60 hover:bg-muted text-muted-foreground transition-all"
            title="Refresh links"
          >
            <RefreshCw className={`size-4 ${isValidating ? 'animate-spin text-foreground' : ''}`} />
          </Button>
          <Button
